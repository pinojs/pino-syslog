...
test('syslog pino transport test stdout', async t => {
  ...
  t.equal(result.stdout.toString().trim(), '<134>1 2016-04-01T16:44:58.958Z MacBook-Pro-3 - 94473 - - hello world')
...
test('syslog pino transport test stderr', async t => {
  ...
  t.equal(result.stderr.toString().trim(), '<134>1 2016-04-01T16:44:58.958Z MacBook-Pro-3 - 94473 - - hello world')
  t.equal(result.status, 0)
})
